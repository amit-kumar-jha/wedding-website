  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-4 py-20 md:flex-row ">
        ...
        >
          <div className="mx-auto max-w-md rounded-3xl border border-white/10 bg-slate-900/70 p-6 shadow-2xl">
            ...
            <dl className="mt-4 space-y-2 text-sm">
              <div className="flex justify-between">
                <dt className="text-slate-400">Haldi</dt>
                <dd className="text-slate-100">25 Nov 2025 · Patna</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-slate-400">Mehndi &amp; Sangeet</dt>
                <dd className="text-slate-100">25 Nov 2025 · Evening</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-slate-400">Baarat</dt>
                <dd className="text-slate-100">
                  26 Nov 2025 · 5:30 AM · Patna → Bhagalpur
                </dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-slate-400">Wedding</dt>
                <dd className="text-slate-100">26 Nov 2025 · Bhagalpur</dd>
              </div>
            </dl>
          </div>
        </motion.div>
