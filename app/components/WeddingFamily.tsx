...
/**
 * Responsive WeddingFamilyAdvanced
 *
 * - Fully responsive layout (mobile → tablet → desktop)
 * - Grid: 1 / 2 / 3 / 4 columns at xs/sm/md/lg
 * - Compact list view & grid view
 * - Controls collapse/wrap on small screens
 * - Touch-friendly buttons and larger hit targets on mobile
 */
  ...
  <div className="flex flex-col gap-3 items-center sm:flex-row sm:items-start sm:justify-between">
    ...
    <div className="flex flex-col gap-2 w-full sm:w-auto sm:flex-row sm:items-center sm:gap-3 items-center">
      ...
      <div
        className={
          view === "grid"
            ? "mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4"
            : "mt-6 space-y-3"
        }
      >
        {visible.length === 0 ? (
